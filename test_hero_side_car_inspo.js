...
(async () => {
    try {
        ...
        <head>
            ...
            <style>
                * { box-sizing: border-box; margin: 0; padding: 0; }
                ...
                /* Right Visual with Car & Dashed Arc */
                .hero-right {
                    position: relative;
                    display: flex;
                    align-items: center;
                ...
                .float-badge i { color: #D97706; font-size: 0.88rem; }

                .float-badge-1 { top: 8%; right: 10%; }
                .float-badge-2 { bottom: 15%; left: 0%; animation-delay: 2s; }
                ...
                <div class="hero-grid">
                    ...
                    <div class="hero-right">
                        ...
                        <svg class="dashed-arc-svg" viewBox="0 0 600 400" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M 50 350 C 150 100, 450 50, 550 200" stroke="#CBD5E1" stroke-width="2" stroke-dasharray="6 6" />
                        </svg>
        ...
        await page.screenshot({ path: path.join(testDir, 'test_hero_side_car_inspo.png') });
        console.log('Saved test_hero_side_car_inspo.png');
        await browser.close();
    } catch (e) {
        console.error(e);
    }
