...
.hero-floating-glass-pill .pill-val i {
    color: #D97706;
    font-size: 0.90rem;
}
...
.hero-floating-glass-pill.pill-top-right {
    top: 15px;
    right: 20px;
}

.hero-floating-glass-pill.pill-bottom-left {
    bottom: 25px;
    left: -15px;
    animation-delay: 2s;
}
...
const heroSideCarHtml = `<!-- ═══════════════════════════════════════════════
     1. BANNER (Home Page Hero — Seamless Blended Car Layout)
════════════════════════════════════════════════ -->
    ...
    <div class="hero-sidecar-container">
        <div class="hero-sidecar-grid">
            ...
            <div class="hero-sidecar-right">
                ...
                <!-- Seamless Studio Vehicle (No Box Container) -->
                <div class="hero-car-seamless-wrap">
                    <img src="Assets/hero_car_seamless.jpg" alt="Mithra Tours & Travels Luxury Fleet" class="hero-car-seamless-img">
                </div>
            </div>
        </div>
    </div>
...
['v2/css/brand.css', 'css/brand.css', 'deploy_ready/css/brand.css'].forEach(f => {
    ...
    console.log('Updated seamless sidecar hero CSS in:', file);
});
...
['v2/index.html', 'index.html', 'deploy_ready/index.html'].forEach(f => {
    ...
    if (startIndex !== -1) {
        ...
        if (endIndex !== -1) {
            ...
            console.log('Applied seamless sidecar Hero HTML in:', file);
        }
    }
});
