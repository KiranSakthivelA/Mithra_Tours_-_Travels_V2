...
(async () => {
    try {
        ...
        <head>
            ...
            <style>
                * { box-sizing: border-box; margin: 0; padding: 0; }
                ...
                .hero-floating-glass-pill.pill-bottom-left { bottom: 25px; left: -15px; animation-delay: 2s; }
            ...
            <section class="hero-inspo-section">
                <div class="hero-grid">
                    ...
                    <div class="hero-left">
                        ...
                        <!-- Floating Search Bar (Symbol Only Send Button) -->
                        <div class="hero-dock">
                            <div class="dock-item">
                    ...
                    <div class="hero-right">
                        ...
                        <!-- Seamless Studio Vehicle (No Box) -->
                        <div class="hero-car-seamless-wrap">
                            <img src="${toBase64('Assets/hero_car_seamless.jpg')}" alt="Mithra Luxury Fleet" class="hero-car-seamless-img">
                        </div>
                    </div>
                </div>
            </section>
        ...
        await page.screenshot({ path: path.join(testDir, 'test_hero_bold_weight_and_symbol.png') });
        console.log('Saved test_hero_bold_weight_and_symbol.png');
        await browser.close();
    } catch (e) {
        console.error(e);
    }
