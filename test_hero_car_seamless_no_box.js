...
(async () => {
    try {
        ...
        <head>
            ...
            <style>
                * { box-sizing: border-box; margin: 0; padding: 0; }
                ...
                /* ── RIGHT COLUMN: SEAMLESS BLENDED CAR (NO BOX) ── */
                .hero-right {
                    position: relative;
                    display: flex;
                    align-items: center;
                ...
                /* Big ambient background wordmark */
                .hero-bg-watermark {
                    position: absolute;
                    font-size: 8.5rem;
                    font-weight: 900;
                ...
                .hero-car-seamless-img {
                    ...
                    height: auto;
                    display: block;
                    mix-blend-mode: multiply; /* Blends pure white background seamlessly into page */
                ...
                /* Floating Feature Badges Overlapping Car */
                .float-badge {
                    position: absolute;
                    background: #FFFFFF;
                    border: 1.5px solid #E2E8F0;
                    ...
                    border-radius: 20px;
                    box-shadow: 0 15px 35px -5px rgba(0, 0, 0, 0.12), 0 2px 8px rgba(0,0,0,0.04);
                    display: flex;
                    flex-direction: column;
                    align-items: flex-start;
                    gap: 0.15rem;
                ...
                .float-badge .badge-title i { color: #D97706; font-size: 0.95rem; }
                ...
                .float-badge-1 { top: 10px; right: 25px; }
                .float-badge-2 { bottom: 25px; left: -10px; animation-delay: 2s; }
        ...
        <body>
            ...
            <section class="hero-inspo-section">
                <div class="hero-grid">
                    ...
                    <!-- Right Visual: Seamless Blended Car (No Box) -->
                    <div class="hero-right">
                        <div class="hero-bg-watermark">MITHRA</div>

                        <!-- Floating Badges -->
                        <div class="float-badge float-badge-1">
                            <div class="badge-title"><i class="fa-solid fa-car-side"></i> 100+</div>
                            <div class="badge-sub">Affiliated Vehicles</div>
                        </div>
                        <div class="float-badge float-badge-2">
                            <div class="badge-title"><i class="fa-solid fa-star"></i> 4.9 / 5</div>
                            <div class="badge-sub">Customer Rating</div>
                        </div>

                        <!-- Studio Car Image Blended with Background -->
                        <div class="hero-car-seamless-wrap">
                            <img src="${toBase64('Assets/car_innova.jpg')}" alt="Mithra Luxury Fleet" class="hero-car-seamless-img">
                        </div>
                    </div>
                </div>
            </section>
        ...
        await page.screenshot({ path: path.join(testDir, 'test_hero_car_seamless_no_box.png') });
        console.log('Saved test_hero_car_seamless_no_box.png');
        await browser.close();
    } catch (e) {
        console.error(e);
    }
