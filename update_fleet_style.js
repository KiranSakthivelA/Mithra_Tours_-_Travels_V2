...
/* 3D Circular Card (Executive Corporate Design) */
.coverflow-card {
    position: absolute;
    width: 290px;
    height: 420px;
    ...
    box-shadow: 0 10px 28px -6px rgba(15, 23, 42, 0.12), 0 4px 10px rgba(0, 0, 0, 0.04);
...
.coverflow-card.active {
    box-shadow: 0 24px 52px -10px rgba(15, 23, 42, 0.25),
...
.coverflow-card:hover .card-image-layer img {
    transform: scale(1.04);
}

/* Card Bottom Gradient — crisp, executive bottom vignette for text contrast */
...
cssFiles.forEach(file => {
    ...
    if (regex.test(css)) {
        ...
        console.log('Successfully regex-replaced CSS in:', file);
    } else {
