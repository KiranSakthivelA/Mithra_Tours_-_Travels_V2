...
/* ═══════════════════════════════════════════════════════════
   HOME PAGE HERO — COMPLETE 2-COLUMN SIDE CAR & STATS LAYOUT
   ═══════════════════════════════════════════════════════════ */
...
const heroSideCarHtml = `<!-- ═══════════════════════════════════════════════
     1. BANNER (Home Page Hero — Complete Side-Car & Stats Layout)
════════════════════════════════════════════════ -->
...
['v2/css/brand.css', 'css/brand.css', 'deploy_ready/css/brand.css'].forEach(f => {
    ...
    console.log('Updated complete sidecar hero CSS in:', file);
});
...
['v2/index.html', 'index.html', 'deploy_ready/index.html'].forEach(f => {
    ...
    if (startIndex !== -1) {
        ...
        if (endIndex !== -1) {
            ...
            console.log('Applied complete sidecar Hero HTML in:', file);
        }
    }
});
